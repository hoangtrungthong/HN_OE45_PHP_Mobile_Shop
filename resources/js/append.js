$(document).ready(function () {
    ...
    html += `
        ...
        <p class="removeEl inline-flex justify-center items-center mt-2 py-1 px-3 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 cursor-pointer">
