                ...
                <div class="carousel w-full relative overflow-hidden">
                    <div class="carousel-inner relative overflow-hidden w-full">
                        ...
                        <div class="carousel-item absolute opacity-0 inline h-96">
                            <img class="m-auto h-96 rounded-2xl" src="{{ asset('images/banners/830-300-830x300-24.png') }}" alt="">
                        </div>
                        ...
                        <input class="carousel-open" type="radio" id="carousel-2" name="carousel" aria-hidden="true"
                            hidden="" />
                        <div class="carousel-item absolute opacity-0 inline h-96">
                            <img class="m-auto h-96 rounded-2xl" src="{{ asset('images/banners/Aseri-830-300-830x300-2.png') }}" alt="">
                        </div>
                        ...
                        <input class="carousel-open" type="radio" id="carousel-3" name="carousel" aria-hidden="true"
                            hidden="" />
                        <div class="carousel-item absolute opacity-0 inline h-96">
                            <img class="m-auto h-96 rounded-2xl" src="{{ asset('images/banners/renno6-seri-830-300-830x300-3.png') }}" alt="">
                        </div>
                        <label for="carousel-2"
